...
import { imgPreview } from './imgPreview'; // Importa la función imgPreview
import { useDebounceEffect } from './useDebounceEffect';

import 'react-image-crop/dist/ReactCrop.css';

// Función para hacer y centrar un recorte de aspecto %
...
export default function App() {
  ...
  function onSelectFile(e) {
    if (e.target.files && e.target.files.length > 0) {
      setCrop(null); // Actualiza el recorte para que la vista previa se actualice entre imágenes.
  ...
  async function onDownloadCropClick() {
    ...
    // Tamaño relativo a la imagen cargada
